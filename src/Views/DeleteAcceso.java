 ...
 * @author camilo.soler
 */
public class DeleteAcceso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton2.setText("Deshabilitar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteAcceso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteAcceso().setVisible(true);
            }
        });
    }
