 ...
 * @author camilo.soler
 */
public class InsertProfiles extends javax.swing.JFrame {

    /**
     * Creates new form InsertUsers
     */
    public InsertProfiles() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(perfil, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 150, 200, 40));
        ...
        jToggleButton2.setText("Agregar Perfil");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertProfiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertProfiles().setVisible(true);
            }
        });
    }
