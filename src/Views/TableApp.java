 ...
 * @author PC
 */
public class TableApp extends javax.swing.JFrame {
    
    ConsultaApp consulta = new ConsultaApp();
    ...
    public TableApp() {
        initComponents();
        tabla = consulta.verapps();
        tablaApp.setModel(tabla);
    }
    /**
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(tablaApp);
        ...
        jLabel1.setText("Aplicaciones Registradas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
